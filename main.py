...
def upload():
    ...
    if file and file.filename.endswith('.pdf') and file.content_type == 'application/pdf':
        # Open the PDF file in binary mode
        with fitz.open(file.read()) as pdf_file:
            ...
            # Returning the extracted information as a JSON response
            return jsonify(data)
    else:
